...
export interface ApiAccreditationListAccreditationList
  ...
  info: {
    ...
    pluralName: 'accreditation-lists';
    singularName: 'accreditation-list';
  };
  options: {
...
export interface ApiAccreditationAccreditation
  extends Struct.CollectionTypeSchema {
...
export interface ApiAtAglanceCardAtAglanceCard
  extends Struct.CollectionTypeSchema {
  collectionName: 'at_aglance_cards';
  info: {
    displayName: 'atAGlanceCard';
    pluralName: 'at-aglance-cards';
    singularName: 'at-aglance-card';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiAtAglanceAtAglance extends Struct.SingleTypeSchema {
  collectionName: 'at_aglances';
  info: {
    displayName: 'atAGlance';
    pluralName: 'at-aglances';
    singularName: 'at-aglance';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hoverable: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::banner.banner'
...
export interface ApiBulletListBulletList extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'bullet-lists';
    singularName: 'bullet-list';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    listIcon: Schema.Attribute.Relation<'manyToOne', 'api::icon.icon'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::bullet-list.bullet-list'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    text: Schema.Attribute.String;
...
export interface ApiClientReviewInfoClientReviewInfo
  extends Struct.CollectionTypeSchema {
  collectionName: 'client_review_infos';
  info: {
    displayName: 'Client Review Info';
    pluralName: 'client-review-infos';
    singularName: 'client-review-info';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomeHeaderSectionHomeHeaderSection
  ...
  info: {
    ...
    pluralName: 'home-header-sections';
    singularName: 'home-header-section';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHowItWorksSectionHowItWorksSection
  ...
  info: {
    ...
    pluralName: 'how-it-works-sections';
    singularName: 'how-it-works-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    overline: Schema.Attribute.String;
    processList: Schema.Attribute.Relation<
      'manyToMany',
      'api::static-step.static-step'
    >;
    publishedAt: Schema.Attribute.DateTime;
    sectionBanner: Schema.Attribute.Relation<'manyToOne', 'api::banner.banner'>;
    sectionSummary: Schema.Attribute.Blocks;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiImageContainerImageContainer
  extends Struct.CollectionTypeSchema {
  collectionName: 'image_containers';
  info: {
    displayName: 'Image Container';
    pluralName: 'image-containers';
    singularName: 'image-container';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProjectCardProjectCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    projectBadges: Schema.Attribute.Relation<'manyToMany', 'api::badge.badge'>;
    projectBanner: Schema.Attribute.Media<'images' | 'files' | 'videos'>;
    projectCategory: Schema.Attribute.Relation<'manyToOne', 'api::badge.badge'>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiRecentWorkSectionRecentWorkSection
  ...
  info: {
    ...
    pluralName: 'recent-work-sections';
    singularName: 'recent-work-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viewAllProjects: Schema.Attribute.Relation<
      'manyToOne',
      'api::button.button'
    >;
  };
...
export interface ApiReviewCardReviewCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    clientInfo: Schema.Attribute.Relation<
      'manyToOne',
      'api::client-review-info.client-review-info'
    >;
...
export interface ApiSiteMetaConfigSiteMetaConfig
  ...
  info: {
    ...
    pluralName: 'site-meta-configs';
    singularName: 'site-meta-config';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultImage: Schema.Attribute.Media<'images' | 'files' | 'videos'>;
    defaultMetaDescription: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    mapLocation: Schema.Attribute.JSON;
    pageTitleTemplate: Schema.Attribute.String;
...
export interface ApiSocialLinkSocialLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    socialNetworkName: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStaticStepStaticStep extends Struct.CollectionTypeSchema {
  collectionName: 'static_steps';
  info: {
    displayName: 'Static Step';
    pluralName: 'static-steps';
    singularName: 'static-step';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    stepOrder: Schema.Attribute.String;
...
export interface ApiWhatWeDoSectionWhatWeDoSection
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workCards: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiWhoWeAreSectionWhoWeAreSection
  ...
  info: {
    ...
    pluralName: 'who-we-are-sections';
    singularName: 'who-we-are-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imageContainer: Schema.Attribute.Relation<
      'manyToOne',
      'api::image-container.image-container'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiWhyChooseUsSectionWhyChooseUsSection
  ...
  attributes: {
    cardBanner: Schema.Attribute.Relation<'manyToOne', 'api::banner.banner'>;
    cardImage: Schema.Attribute.Relation<
      'manyToOne',
      'api::image-container.image-container'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    listOfPoints: Schema.Attribute.Relation<
      'manyToMany',
      'api::bullet-list.bullet-list'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiWorkCardWorkCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    priceLine: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::accreditation-list.accreditation-list': ApiAccreditationListAccreditationList;
      'api::accreditation.accreditation': ApiAccreditationAccreditation;
      'api::at-aglance-card.at-aglance-card': ApiAtAglanceCardAtAglanceCard;
      'api::at-aglance.at-aglance': ApiAtAglanceAtAglance;
      ...
      'api::who-we-are-section.who-we-are-section': ApiWhoWeAreSectionWhoWeAreSection;
